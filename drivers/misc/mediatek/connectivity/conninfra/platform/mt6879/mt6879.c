...
static int consys_pre_cal_backup_mt6879(unsigned int offset, unsigned int size);
static int consys_pre_cal_clean_data_mt6879(void);
...
struct consys_hw_ops_struct g_consys_hw_ops_mt6879 = {
	...
	.consys_plt_pre_cal_backup = consys_pre_cal_backup_mt6879,
	.consys_plt_pre_cal_clean_data = consys_pre_cal_clean_data_mt6879,
};
...
int consys_pre_cal_restore_mt6879(void)
{
	 ...
	 */
	consys_spi_write_nolock_mt6879(SYS_SPI_TOP, 0xb04, 0xfe000000);
	consys_spi_write_nolock_mt6879(SYS_SPI_TOP, 0xb08, 0xe0000000);
	consys_spi_write_nolock_mt6879(SYS_SPI_TOP, 0xa04, 0xffffffff);
	consys_spi_write_nolock_mt6879(SYS_SPI_TOP, 0xaf4, 0xffffffff);
	/* Write CR back, SYS_SPI_WF & SYS_SPI_WF1 */
	for (i = 0; i < mt6637_backup_cr_number; i++) {
		consys_spi_write_nolock_mt6879(
			SYS_SPI_WF,
	 ...
	 */
	consys_spi_write_nolock_mt6879(SYS_SPI_TOP, 0xb04, 0x88000000);
	consys_spi_write_nolock_mt6879(SYS_SPI_TOP, 0xb08, 0x00000000);
	consys_spi_write_nolock_mt6879(SYS_SPI_TOP, 0xa04, 0x00000000);
	consys_spi_write_nolock_mt6879(SYS_SPI_TOP, 0xaf4, 0x00000000);
	/* Release semaphore */
